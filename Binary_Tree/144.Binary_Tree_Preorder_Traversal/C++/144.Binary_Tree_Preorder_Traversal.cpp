...
public:
    void dfsTraversal(TreeNode * root, vector<int> & res_vect)
    {
        ...
        dfsTraversal((root->left), res_vect); //Resursion function call (i.e. root left-half node)
        dfsTraversal((root->right), res_vect); //Resursion function call (i.e. root right-half node)
    }
