...
public:
    int numOfMinutes(int n, int headID, vector<int> & manager, vector<int> & informTime) 
    {
        ...
        //   - vector<int> ref. (informTime vector) //
        // Return type:                             //
        ...
        return dfsbfsTraversal(record_map, (-1), 0); //Recursion function call
    }


    int dfsbfsTraversal(unordered_map<int, vector<pair<int, int>>> & record_map, int record_manager, int record_time)
    {
        //==================================================================================//
        // Input type:                                                                      //
        ...
        {
            tmp_time = dfsbfsTraversal(record_map, record_pair.first, (record_time + record_pair.second)); //Recursion function call
