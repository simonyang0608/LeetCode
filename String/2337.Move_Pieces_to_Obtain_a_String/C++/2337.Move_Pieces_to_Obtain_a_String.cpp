...
public:
    bool canChange(string start, string target) 
    {
        ...
        for (int string_idx = 0; (string_idx < len_string); (string_idx++)) //Left
        {
            ...
            if (target[string_idx] == 'L') { record_left_stack.push('L'); } //Keep updating, recording
            else { ; }
            ...
            {
                ///// Check if the current indexed-char matched conditions or not /////
                if ((start[string_idx] == 'R') || (target[string_idx] == 'R')) { return false; }
        ...
        {
            ///// Check if the current indexed-char matched conditions or not /////
            if (target[string_idx] == 'R') { record_right_stack.push('R'); } //Keep updating, recording
            else { ; }
            ...
            {
                ///// Check if the current indexed-char matched conditions or not /////
                if ((start[string_idx] == 'L') || (target[string_idx] == 'L')) { return false; }
